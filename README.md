...
| Paper Figure | Repository File | Description |
|---|---|---|
| **Figure 1** | `figures/framework_architecture.png` | High-level architecture of the proposed tear-proteomic PD-spectrum framework |
| **Figure 2** | `figures/experimental_pipeline.png` | Complete experimental workflow from preprocessing through external evaluation |
| **Figure 18** | `figures/external_validation_performance.png` | Independent external validation performance on PXD028811 |
| **Figure 19** | `figures/external_confusion_matrix.png` | External confusion matrix showing class-level prediction behavior |

### Optional Figures

If additional figures are later uploaded to the same `figures/` folder, the following can also be included:
...
For a clean GitHub presentation, the main README uses Figures **1, 2, 18, and 19**.
